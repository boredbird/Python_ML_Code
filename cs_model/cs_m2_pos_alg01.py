...
if __name__ == '__main__':
    # dataset_list = []
    # dataset_path1 = 'E:\\ScoreCard\\cs_model\\cs_m1_pos_model\\raw_data\\zdy_m2_910_poscash_cs_BASE_V1.csv'
    # dataset1 = pd.read_csv(dataset_path1)
    # dataset_list.append(dataset1)
    # dataset_path2 = 'E:\\ScoreCard\\cs_model\\cs_m1_pos_model\\raw_data\\zdy_m2_1112_poscash_cs_BASE_V1.csv'
    # dataset2 = pd.read_csv(dataset_path2)
    # dataset_list.append(dataset2)
    # dataset.groupby('sub_product_type').count().iloc[:,1]
    # sub_product_type
    # 0    418595
    # 1     61103

    # pos_path = 'E:\\ScoreCard\\cs_model\\cs_m1_pos_model\\raw_data\\zdy_m2_910_poscash_cs_BASE_V1_pos.csv'
    # dataset[dataset['sub_product_type']==0].to_csv(pos_path,index=False)

    # dataset_all = pd.DataFrame()
    # dataset_all = dataset_all.append(dataset_list)

    # all_pos_path = 'E:\\ScoreCard\\cs_model\\cs_m1_pos_model\\raw_data\\zdy_m2_912_poscash_cs_BASE_V1_pos.csv'
    # dataset_all[dataset_all['sub_product_type']==0].to_csv(all_pos_path,index=False)

    config_path = 'E:\\Code\\Python_ML_Code\\cs_model\\config\\config_cs_model_pos_m2.csv'

    # feature_detail,rst = process_train_woe(infile_path=all_pos_path
    #                                        ,outfile_path=r'E:\ScoreCard\cs_model\cs_m2_pos_model\features_detail\cs_m2_pos_912_features_detail.csv'
