...
df_tmp = dataset_order_set1[['uid','qty']]
user_order_features['uid_qty_cnt'] = df_tmp.groupby(['uid']).agg({'qty': pd.Series.nunique})

df_tmp = dataset_order_set1[['uid','cate_id']]
user_order_features['uid_cate_cnt'] = df_tmp.groupby(['uid']).agg({'cate_id': pd.Series.nunique})
...
df_tmp = dataset_order_set1[['uid','cate_id','qty']]
user_order_features['uid_cate_qty_cnt'] = df_tmp.groupby(['uid','cate_id']).agg({'qty': pd.Series.nunique})
...
df_tmp = dataset_click_set1[['uid','pid']]
user_click_features['user_click_pid_cnt'] = df_tmp.groupby(['uid']).agg({'pid': pd.Series.nunique})

df_tmp = dataset_click_set1[['uid','param']]
user_click_features['user_click_param_cnt'] = df_tmp.groupby(['uid']).agg({'param': pd.Series.nunique})
...
user_click_features['user_click_pid_param_cnt'] = df_tmp.groupby(['uid','pid']).agg({'param': pd.Series.nunique})
...
user_click_features['user_click_param_pid_cnt'] = df_tmp.groupby(['uid','param']).agg({'pid': pd.Series.nunique})
...
df_tmp = dataset_sex_order_set1[['sex','qty']]
sex_features['sex_qty_cnt'] = df_tmp.groupby(['sex']).agg({'qty': pd.Series.nunique})

df_tmp = dataset_sex_order_set1[['sex','cate_id']]
sex_features['sex_cate_cnt'] = df_tmp.groupby(['sex']).agg({'cate_id': pd.Series.nunique})
...
sex_features['uid_cate_qty_cnt'] = df_tmp.groupby(['sex','cate_id']).agg({'qty': pd.Series.nunique})
...
dataset_sex_loan_set1 = pd.merge(dataset_sex,dataset_order_set1,on=['uid'],how='left')
...
sex_features['sex_click_pid_param_cnt'] = df_tmp.groupby(['sex','pid']).agg({'param': pd.Series.nunique})
...
sex_features['sex_click_param_pid_cnt'] = df_tmp.groupby(['sex','param']).agg({'pid': pd.Series.nunique})
...
df_tmp = dataset_cate[['cate_id','qty']]
cate_features['cate_id_qty_cnt'] = df_tmp.groupby(['cate_id','pid']).agg({'qty': pd.Series.nunique})
