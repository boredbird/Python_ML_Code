...
if __name__ == '__main__':
    ...
    feature_detail_path1 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_acard_validation_features_detail1.csv'
    feature_detail_path2 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_acard_validation_features_detail2.csv'
    feature_detail_path3 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_acard_validation_features_detail3.csv'
    rst_pkl_path1 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_acard_validation_woe_rule1.pkl'
    rst_pkl_path2 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_acard_validation_woe_rule2.pkl'
    rst_pkl_path3 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_acard_validation_woe_rule3.pkl'
    # feature_detail,rst = process_train_woe(infile_path=dataset_test_path1
    #                                        ,outfile_path=feature_detail_path1
    #                                        ,rst_path=rst_pkl_path1
    #                                        ,config_path=config_path)
    # feature_detail,rst = process_train_woe(infile_path=dataset_test_path2
    #                                        ,outfile_path=feature_detail_path2
    #                                        ,rst_path=rst_pkl_path2
    #                                        ,config_path=config_path)
    # feature_detail,rst = process_train_woe(infile_path=dataset_test_path3
    #                                        ,outfile_path=feature_detail_path3
    #                                        ,rst_path=rst_pkl_path3
    #                                        ,config_path=config_path)

    woe_train_path1 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_train1_woed.csv'
    # process_woe_trans(dataset_train_path1,rst_pkl_path1,woe_train_path1,config_path)
    woe_test_path1 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_test1_woed.csv'
    # process_woe_trans(dataset_test_path1,rst_pkl_path1,woe_test_path1,config_path)

    woe_train_path2 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_train2_woed.csv'
    # process_woe_trans(dataset_train_path2,rst_pkl_path2,woe_train_path2,config_path)
    woe_test_path2 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_test2_woed.csv'
    # process_woe_trans(dataset_test_path2,rst_pkl_path2,woe_test_path2,config_path)

    woe_train_path3 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_train3_woed.csv'
    # process_woe_trans(dataset_train_path3,rst_pkl_path3,woe_train_path3,config_path)
    woe_test_path3 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_test3_woed.csv'
    # process_woe_trans(dataset_test_path3,rst_pkl_path3,woe_test_path3,config_path)

    df_cor_path1 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_test1_woed_df_cor.csv'
    df_cor_path2 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_test2_woed_df_cor.csv'
    df_cor_path3 = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_test3_woed_df_cor.csv'

    # proc_cor_eval(woe_test_path1,config_path,var_list_specfied=[],out_file_path=df_cor_path1)
    # proc_cor_eval(woe_test_path2,config_path,var_list_specfied=[],out_file_path=df_cor_path2)
    # proc_cor_eval(woe_test_path3,config_path,var_list_specfied=[],out_file_path=df_cor_path3)

    print '###################################target1_v3##############################################'
    params1 = {}
    params1['dataset_path'] = woe_test_path1
    params1['validation_path'] = woe_train_path1
    params1['config_path'] = config_path

    params1['df_coef_path'] = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_df_coef_target1_v3.csv'
    params1['pic_coefpath'] = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_coefpath_target1_v3.png'
    params1['pic_performance'] = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_performance_path_target1_v3.png'
    ...
    params1['var_list_specfied'] = ['callin_mem_avg_duration',
                                    'callin_mem_cnt',
                                    'rate_num_sj_cnt',
                                    'rate_name_one_cnt',
                                    'addr_valid_mem_rate',
    ...
    print '###################################target2_v3##############################################'
    params2 = {}
    params2['dataset_path'] = woe_test_path2
    params2['validation_path'] = woe_train_path2
    params2['config_path'] = config_path

    params2['df_coef_path'] = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_df_coef_target2_v3.csv'
    params2['pic_coefpath'] = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_coefpath_target2_v3.png'
    params2['pic_performance'] = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_performance_path_target2_v3.png'
    ...
    params2['var_list_specfied'] = ['callin_mem_avg_duration',
                                'rate_num_charcnt',
                                'callin_mem_cnt',
                                'rate_num_sj_cnt',
                                'rate_ex_short_cnt',
    ...
    print '###################################target3_v3##############################################'
    params3 = {}
    params3['dataset_path'] = woe_test_path3
    params3['validation_path'] = woe_train_path3
    params3['config_path'] = config_path

    params3['df_coef_path'] = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_df_coef_target3_v3.csv'
    params3['pic_coefpath'] = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_coefpath_target3_v3.png'
    params3['pic_performance'] = r'E:\work_file\mmt_application_card\validation_as_trainset\mmt_application_model_performance_path_target3_v3.png'
    ...
    params3['var_list_specfied'] = ['callin_mem_avg_duration',
                                'callin_mem_cnt',
                                'rate_ex_short_cnt',
                                'rate_name_one_cnt',
                                'non_addr_call_rate',
